...
import { Button, Table, Modal, Form, Pagination, Message } from 'semantic-ui-react'
...
class CustomerTable extends Component {
  state = {
    ...
    Delete = (Id) => {
      ...
      axios
          .delete("http://localhost:55706/api/Customers/"+Id, {
  ...
  closeConfigShow2 = (closeOnEscape, closeOnDimmerClick , Id) => () => {
    ...
    UpdateRow = (Id) => {
        if (this.state.Name != '' && this.state.Address != '') {
            axios
                .put("http://localhost:55706/api/Customers/" + Id, {
